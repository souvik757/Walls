...
public class SavedWallpaperRVModel {
    ...
    public SavedWallpaperRVModel(String ID, String URL, String ALT, String PHOTOGRAPHER_NAME, String WIDTH, String HEIGHT , String PHOTOGRAPHER_INFO_URL , String AVG_COLOR) {
        this.ID = ID;
        this.URL = URL;
        this.ALT = ALT;
